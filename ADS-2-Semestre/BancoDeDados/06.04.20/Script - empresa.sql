...
/*
select p.nome_prod, f.nome_forn from produtos p, fornecedores f;
*/


select prod_id from produtos left join marcas on produtos.marca_id = marcas.marca_id where nome_prod = 'borracha' and nome_marca = 'Labra';

select forn_id from fornecedores where nome_forn = 'Los Pollos Hermanos';
...
insert into produto_fornecedor values (
	(select prod_id from produtos left join marcas on produtos.marca_id = marcas.marca_id where nome_prod = 'lapis' and nome_marca = 'Labra')
		,
	(select forn_id from fornecedores where nome_forn = 'Los Pollos Hermanos')
);
insert into produto_fornecedor values (
	(select prod_id from produtos left join marcas on produtos.marca_id = marcas.marca_id where nome_prod = 'caderno' and nome_marca = 'Faber Castel')
		,
	(select forn_id from fornecedores where nome_forn = 'Los Pollos Hermanos')
);
